...
class SecurityConfigTest {
    ...
    void corsConfigurationSource_containsExpectedOriginsMethodsAndHeaders() {
        ...
        CorsConfiguration config = source.getCorsConfiguration(new MockHttpServletRequest("GET", "/api/v1/payments"));
        ...
        assertThat(config.getAllowedHeaders()).contains("Authorization", "Content-Type", "X-Request-ID", "X-Correlation-ID", "Stripe-Signature");
